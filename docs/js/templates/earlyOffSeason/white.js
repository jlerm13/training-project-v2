                    ...
                    week3: {
                        monday: {
                            ...
                            exercises: [
                                ...
                                { type: "circuit-a", order: "A1", exercise: "dbSlantboardGobletSquat", sets: "3 × 6", tempo: "3 seconds down, 1 second up", rest: "30s", note: "Keep week 2 weight, adding 1 more set", media: { photo: "assets/exercises/white/db-slantboard-goblet-squat.jpg", video: "assets/exercises/white/db-slantboard-goblet-squat.mp4" } },
                        ...
                        friday: {
                            ...
                            exercises: [
                                ...
                                { type: "tri-set-d", order: "D2", exercise: "trxKneeTucks", sets: "2 × 12/side", tempo: "Smooth and steady", rest: "20s", note: "Lower arms and legs slowly, keep back flat on ground", media: { photo: "assets/exercises/white/deadbugs.jpg", video: "assets/exercises/white/deadbugs.mp4" } },
                                { type: "tri-set-d", order: "D3", exercise: "pallofPressHolds", sets: "2 × 30/side", tempo: "Smooth and steady", rest: "45s", note: "Start low, twist up and across your body", media: { photo: "assets/exercises/white/db-low-high-chop.jpg", video: "assets/exercises/white/db-low-high-chop.mp4" } }
                            ]
                        }
                    },
                    ...
                    week4: {
                        ...
                        friday: {
                            ...
                            exercises: [
                                ...
                                // TRI-SET D - Core (Week 4: maintain week 3)
                                { type: "tri-set-d", order: "D1", exercise: "plankElbows", sets: "3 × 30s", tempo: "Hold steady", rest: "20s", note: "Elbows under shoulders, squeeze glutes, hold straight line", media: { photo: "assets/exercises/white/plank-elbows.jpg", video: "assets/exercises/white/plank-elbows.mp4" } },
                                { type: "tri-set-d", order: "D2", exercise: "deadbugs", sets: "3 × 10/side", tempo: "Smooth and steady", rest: "20s", note: "Lower arms and legs slowly, keep back flat on ground", media: { photo: "assets/exercises/white/deadbugs.jpg", video: "assets/exercises/white/deadbugs.mp4" } },
                                { type: "tri-set-d", order: "D3", exercise: "dbLowHighChop", sets: "3 × 15/side", tempo: "Smooth and steady", rest: "45s", note: "Start low, twist up and across your body", media: { photo: "assets/exercises/white/db-low-high-chop.jpg", video: "assets/exercises/white/db-low-high-chop.mp4" } }
                            ]
                        }
                    }
                },
